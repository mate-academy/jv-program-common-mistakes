...
Use this code instead of your previous implementation of injector. 
Add annotation `Service` like `Dao` and use it over classes implementation on service layer.
